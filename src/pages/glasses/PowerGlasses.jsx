  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-gradient-to-br from-teal-50 to-cyan-100">
        ...
        <p className="mt-6 text-2xl font-semibold text-gray-700">Focusing on your perfect vision...</p>
      </div>
    );
  }
      ...
      <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
        ...
        {products.length === 0 ? (
          ...
          >
            ...
            <h2 className="text-3xl font-semibold text-gray-700 mb-4">No power glasses available at the moment</h2>
            <p className="text-xl text-gray-600">Our new collection is coming soon. Stay tuned!</p>
          </motion.div>
        ) : (
          <>
          <motion.div
